...
export const SEED_EXPORT_JOBS: ExportJob[] = [
  ...
  },
  {
    ...
    range: "20 May 2025",
    destination: "Analysis Cluster (NFS)",
    format: "TAR.GZ",
    sizeBytes: 264 * GB,
    progress: 41,
    status: "transferring",
